...
_See code: [src/commands/info/releasenotes/display.ts](https://github.com/salesforcecli/plugin-info/blob/v1.2.1/src/commands/info/releasenotes/display.ts)_
